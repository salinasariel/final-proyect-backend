...
namespace final_proyect.Migrations
{
    ...
    [Migration("20240411005846_Foreigh")]
    partial class Foreigh
    {
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("final_proyect_backend.Models.Applications", b =>
                {
                    b.HasOne("final_proyect_backend.Models.Offers", "Offers")
                        .WithMany()
                        .HasForeignKey("OfferId")
                        .OnDelete(DeleteBehavior.Restrict)
                        .IsRequired();

                    b.HasOne("final_proyect_backend.Models.Users", "Users")
                        .WithMany()
